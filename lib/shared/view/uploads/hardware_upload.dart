...
class HardwareUpload extends StatefulWidget {
  const HardwareUpload({super.key});

  @override
  HardwareUploadState createState() => HardwareUploadState();
}

class HardwareUploadState extends State<HardwareUpload> {
